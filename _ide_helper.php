...
')
     ...
     */ 
         ...
         * @static 
         */ 
        public static function getToken($entity, $customPayload = [])
        {
                        /** @var \App\Services\JWT $instance */
                        return $instance->getToken($entity, $customPayload);
        }
                    /**
         * 
         *
         * @static 
         */ 
        public static function isValidToken($token, $entity)
        {
                        /** @var \App\Services\JWT $instance */
                        return $instance->isValidToken($token, $entity);
        }
...
namespace  { 
            ...
            class JWT extends \App\Facades\JWT {}
